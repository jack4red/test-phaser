var menu_state={
	create: function(){
		...
		var text = game.add.text(400,500,"Press enter to start!",style);		//定义显示文本变量,并在game.world显示，参数(坐标,显示文本,文本风格)
		...
		var space_key = this.game.input.keyboard.addKey(Phaser.Keyboard.ENTER);		//定义接受按键消息变量
